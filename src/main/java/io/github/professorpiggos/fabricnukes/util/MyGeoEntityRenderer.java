//I was having so many issues I just gave up. This is very unmaintable, whatever.
...
public abstract class MyGeoEntityRenderer<T extends LivingEntity & IAnimatable> extends EntityRenderer<T> implements IGeoRenderer<T> {
    static {
    ...
    protected MyGeoEntityRenderer(EntityRendererFactory.Context renderManager, AnimatedGeoModel<T> modelProvider) {
        super(renderManager);
